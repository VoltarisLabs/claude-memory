    ...
    <div className="min-h-screen bg-black text-white relative flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-[8rem] sm:text-[12rem] font-bold leading-none font-['Urbanist'] bg-gradient-to-r from-[#0080FF] via-[#4F1AD6] to-[#00F6FF] bg-clip-text text-transparent"
        >
          404
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl text-white/60 mb-4 font-['Urbanist']"
        >
          Page Not Found
        </motion.p>
        ...
        <motion.p
          ...
          className="text-white/40 mb-10 font-['Urbanist']"
        >
